...
!#endif  
        ...
        tmax(row)=max(maxval(m_icel(nghbr_nod2D(row)%addresses(1:n))), maxval(m_ice(nghbr_nod2D(row)%addresses(1:n))))   !RG45871
        tmin(row)=min(minval(m_icel(nghbr_nod2D(row)%addresses(1:n))), minval(m_ice(nghbr_nod2D(row)%addresses(1:n))))   !RG45871
