pro do_output2,outdir,rank,mergedbathy,mergeddraft,mergedheight,mergeditemp,mergedamask,mergedimask,mergedomask,sourcebathy,sourcedraft
...
close,1
print,'write mergeditemp'+crank+' to file'
openw,1,outdir+'mergeditemp'+crank+'.bin',/swap_if_big_endian
writeu,1,mergeditemp
close,1
