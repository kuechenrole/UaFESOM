...
doinit          = 0      ; 1. initialize regular grid
...
mergepism        = 0    ;       merge PISM patch into merggeddata6, output of mergeddata10_yyyy
readmergeddata     = 0     ;       Seiteneinstieg

makecoastlines   = 0     ; P.1 create coastline/grounding line to be used on plots

coupled          = 0    ;       set to 1 to run mashinery as part of coupled model
...
;  icefile=pismtopodir+'pism_bedmachine_equi_1km_200yrs.nc'
  ciceyear='1950'
  icefile=pismtopodir+'pism_to_fesom_1km_'+ciceyear+'.nc'
 endelse
...
;  plotbiniez,icemask,icelon,icelat,'fris',0,5,'icemask '+ciceyear,3
...
;  plotbiniez,icebot,icelon,icelat,'fris',-2000,2000,'icebot',7
 ...
 if vis then begin
  plotbiniez,iceimask,icelon,icelat,'fris',-0.1,1.1,'iceimask '+ciceyear,8
...
;                  mergedamaskout,mergedimaskout,mergedomaskout,[2,2,2,1],xrg,yrg,wctmin,vis,'fris'     ; from RAnGO-1


 make_consistent2,mergedbathyout,mergeddraftout,mergedheightout,$
                  mergedamaskout,mergedimaskout,mergedomaskout,[2,0,2,1],xrg,yrg,wctmin,vis,'fris'      ; for RAnGO-2 (RG454950)


 if vis then begin 
  plotbinrez,mergeddraftout,xrg,yrg,'fris',0,0,'mergeddraftout',23
  plotbinrez,mergedamaskout,xrg,yrg,'fris',0,0,'mergedamaskout',24
  plotbinrez,mergedimaskout,xrg,yrg,'fris',0,0,'mergedimaskout',25
  plotbinrez,mergedomaskout,xrg,yrg,'fris',0,0,'mergedomaskout',26
 endif
 ...
 if dooutput then begin
  print,'outdir=',outdir
  do_output,outdir,-iceyear,mergedbathyout,mergeddraftout,mergedheightout,$
...
if makecoastlines then begin
 amask=mergedamask2150
 omask=mergedomask2150
