...
subroutine read_mesh
  ...
  character*180   file_name
  character*180   cfile_name
  character*180   dist_mesh_dir

  write(mype_string,'(i4.4)') mype  
  write(*,*) mype,mype_string
  ...
  cfile_name=trim(dist_mesh_dir)//'com_info'//trim(mype_string)//'.out'  
  fileID=10+mype  
