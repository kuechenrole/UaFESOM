...
%arguments
filename = "../externalData/racmo/RACMO2.3p1_ANT27_SMB_yearly_1979_2014_folder.nc/RACMO2.3p1_ANT27_SMB_yearly_1979_2014.nc" ;
latlonfilename = "../externalData/racmo/RACMO2.3p1_ANT27_SMB_yearly_1979_2014_folder.nc/RACMO2.3p1_ANT27_Height_lat_lon.nc" ;
SaveOutputs = true ;
%end
...
smb = mean(smb,4).*(3600*24*365.25*rhow/rhoi/1000);

%fprintf("...done.\n")

%fprintf(' Generating some figures of raw data...')
figure(10) ; imagesc(rlat,rlon,smb(:,:,1,1)); axis xy equal;  title(' smb in i.e. per a' ) ; colorbar ; axis tight; %caxis([0 0.1]);
...
if SaveOutputs
    ...
    save('../myInterpolants/surfaceMassBalanceForAntarcticaBasedOnRacmo','Fas')
end
